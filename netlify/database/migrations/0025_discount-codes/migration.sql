-- Generated from migrations/0025_discount_codes.sql; do not edit this copy.
CREATE TABLE IF NOT EXISTS _migrations (name TEXT PRIMARY KEY, applied_at TIMESTAMPTZ NOT NULL DEFAULT now());
DO $netlify_apply$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM _migrations WHERE name = '0025_discount_codes.sql') THEN
...
-- No seeded promotions. Only an authorized admin may create or activate a code.
    ...
    INSERT INTO _migrations (name) VALUES ('0025_discount_codes.sql');
  END IF;
END
$netlify_apply$;
