-- Generated from migrations/0001_auth.sql; do not edit this copy.
CREATE TABLE IF NOT EXISTS _migrations (name TEXT PRIMARY KEY, applied_at TIMESTAMPTZ NOT NULL DEFAULT now());
DO $netlify_apply$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM _migrations WHERE name = '0001_auth.sql') THEN
...
create index if not exists "verification_identifier_idx" on "verification" ("identifier");
    ...
    INSERT INTO _migrations (name) VALUES ('0001_auth.sql');
  END IF;
END
$netlify_apply$;
