-- Generated from migrations/0027_player_fundraising.sql; do not edit this copy.
CREATE TABLE IF NOT EXISTS _migrations (name TEXT PRIMARY KEY, applied_at TIMESTAMPTZ NOT NULL DEFAULT now());
DO $netlify_apply$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM _migrations WHERE name = '0027_player_fundraising.sql') THEN
...
CREATE TABLE fundraising_rate_limits(key text PRIMARY KEY,count integer NOT NULL,expires bigint NOT NULL);
    ...
    INSERT INTO _migrations (name) VALUES ('0027_player_fundraising.sql');
  END IF;
END
$netlify_apply$;
