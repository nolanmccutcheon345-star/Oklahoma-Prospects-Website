-- Generated from migrations/0020_square_payments.sql; do not edit this copy.
CREATE TABLE IF NOT EXISTS _migrations (name TEXT PRIMARY KEY, applied_at TIMESTAMPTZ NOT NULL DEFAULT now());
DO $netlify_apply$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM _migrations WHERE name = '0020_square_payments.sql') THEN
...
update club_services set remote=1 where id='m3';
    ...
    INSERT INTO _migrations (name) VALUES ('0020_square_payments.sql');
  END IF;
END
$netlify_apply$;
