-- Generated from migrations/0013_v2_authority.sql; do not edit this copy.
CREATE TABLE IF NOT EXISTS _migrations (name TEXT PRIMARY KEY, applied_at TIMESTAMPTZ NOT NULL DEFAULT now());
DO $netlify_apply$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM _migrations WHERE name = '0013_v2_authority.sql') THEN
...
do $$ declare t text; begin
 ...
 foreach t in array array['owner_grants','club_households','household_members','audit_events'] loop
  ...
  execute format('revoke all on %I from public',t);
    ...
    INSERT INTO _migrations (name) VALUES ('0013_v2_authority.sql');
  END IF;
END
$netlify_apply$;
