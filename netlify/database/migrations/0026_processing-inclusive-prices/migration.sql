-- Generated from migrations/0026_processing_inclusive_prices.sql; do not edit this copy.
CREATE TABLE IF NOT EXISTS _migrations (name TEXT PRIMARY KEY, applied_at TIMESTAMPTZ NOT NULL DEFAULT now());
DO $netlify_apply$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM _migrations WHERE name = '0026_processing_inclusive_prices.sql') THEN
...
update club_services set price=104 where id='s12';
    ...
    INSERT INTO _migrations (name) VALUES ('0026_processing_inclusive_prices.sql');
  END IF;
END
$netlify_apply$;
