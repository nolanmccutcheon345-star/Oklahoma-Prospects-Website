...
export const Route=createFileRoute("/visits")({head:()=>pageHead("/visits","Check In","Find your confirmed reservations and check in to Oklahoma Prospects.",true),component:Visits});
