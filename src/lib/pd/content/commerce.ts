...
export const SERVICES_INIT = [
  {
    ...
    coachSplit: 55,
    entry: true,
    purpose: "Required entry point. 75 minutes, not an ordinary lesson.",
  },
  {
    id: "s2",
    name: "Private Development 30",
    discipline: "Pitching",
    price: dollars("s2"),
    duration: 30,
    coachSplit: 60,
    purpose: "Focused recurring session.",
  },
  {
    id: "s3",
    name: "Private Development 60",
    discipline: "Pitching",
    price: dollars("s3"),
    duration: 60,
    coachSplit: 60,
    purpose: "Full development session.",
  },
  {
    id: "s4",
    name: "Pitching Lab / Reassessment",
    discipline: "Pitching",
    price: dollars("s4"),
    duration: 60,
    coachSplit: 55,
    purpose: "Objective testing and pitch design.",
  },
  {
    id: "s5",
    ...
    duration: 20,
    coachSplit: 65,
    purpose: "Asynchronous film feedback.",
  },
  {
    id: "s6",
    name: "Small-Group Pitcher Development",
    discipline: "Pitching",
    price: dollars("s6"),
    duration: 75,
    coachSplit: 50,
    group: true,
    purpose: "Weekly coached training, 3–5 pitchers. Billed monthly.",
  },
  {
    id: "s7",
    name: "Private Hitting 30",
    discipline: "Hitting",
    price: dollars("s7"),
    duration: 30,
    coachSplit: 60,
  ...
  },
  {
    ...
    duration: 60,
    coachSplit: 55,
    purpose: "Baseline swing, contact and power.",
  },
  {
    id: "s10",
    name: "Private Catching 30",
    discipline: "Catching",
    price: dollars("s10"),
    duration: 30,
    coachSplit: 60,
  ...
  {
    id: "s12",
    name: "Private Fielding 60",
    discipline: "Fielding",
    price: dollars("s12"),
    duration: 60,
    coachSplit: 60,
    purpose: "Infield or outfield development.",
  },
] as const;
...
export const MEMBERSHIPS_INIT = [
  {
    ...
    remote: 0,
    rollover: "1 session",
    blurb: "Four 30-minute sessions plus the development system.",
    includes: [
      "Four 30-minute sessions",
      "Athlete profile",
      "Personal development priorities",
      "Drill library assignments",
      "Session recaps",
      "Throwing and workload tracking",
  ...
  },
  {
    ...
    remote: 1,
    rollover: "1 session",
    blurb: "Four 60-minute sessions plus video and pitch development.",
    includes: [
      "Four 60-minute sessions",
      "Everything in Development",
      "Video analysis",
      "Expanded command work",
      "Pitch development",
      "Periodic reassessment",
      "Game-performance tracking",
      "Priority recurring slot",
    ],
  },
  {
    id: "m3",
    tier: "elite",
    name: "Elite Hybrid Membership",
    price: dollars("m3"),
    lessons: 4,
    minutes: 60,
    remote: 1,
    rollover: "1 session",
    blurb: "Everything in Performance plus film review and higher-touch support.",
    includes: [
      "Everything in Performance",
      "One monthly game-film review",
      "Higher-touch asynchronous video feedback",
      "Monthly roadmap update",
      "Quarterly Pitching Lab / advanced assessment",
      "Priority scheduling",
    ],
  },
  {
    id: "m4",
    tier: "group",
    name: "Small-Group Development",
    price: dollars("m4"),
    lessons: 4,
    minutes: 75,
    remote: 0,
    rollover: "1 session, once",
    blurb: "One 75-minute group session weekly, 3–5 comparable pitchers.",
    includes: [
      "Weekly 75-minute group session",
      "Command competition and mound situations",
      "Athlete profile",
      "Session recaps",
    ],
  },
  {
    id: "m5",
    tier: "remote",
    name: "Remote HS Pitching Coaching",
    price: dollars("m5"),
    lessons: 0,
    minutes: 0,
    remote: 4,
    rollover: "1 session, once",
    blurb: "Fully remote programming and film feedback.",
    includes: [
      "Monthly programming",
      "Four video reviews",
      "Throwing and workload tracking",
